                            ...
                            <div class="mega-category-menu">
                                ...
                                <ul class="sub-category">
                                    <li v-for="(category, index) in categories" :key="index">
                                        <router-link :to="{name: 'category', params:{id: category.id}}"> {{category.name}}<i class="lni lni-chevron-right"></i></router-link>
                                        <ul class="inner-sub-category">
                                            <li v-for="(sub_category, index) in category.sub_category" :key="index">
                                                <a href="product-grids.html">{{sub_category.name}}</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
...
<script>
    ...
    export default {
        ...
        created() {
            axios.get('http://localhost/Jproject/public/api/test').then(response => {
