                        ...
                        <div class="product-grids-head">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-grid" role="tabpanel" aria-labelledby="nav-grid-tab">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-12" v-for="(product, index2) in products" :key="index2">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h4 class="title">
                                                        <router-link href="product-grids.html" :to="{name: 'detail',params:{id:product.id}}">{{product.name}}</router-link>
                                                    </h4>
                                                    <ul class="review">
...
<script>
    ...
    export default {
        ...
        created() {
            document.title = 'Product Category Page';
            axios.get('http://localhost/Jproject/public/api/get-category-product/' + this.id).then(response => {
