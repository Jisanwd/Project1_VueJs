                            ...
                            <div class="product-images">
                                <main id="gallery">
                                    ...
                                    <div class="images">
                                        ...
                                        <img v-for="(other_image, index) in product.other_images" :key="index" :src="other_image.image" class="img" alt="#">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group color-option">
                                            ...
                                            <input type="number" v-model="qty" min="1" required class="form-control">
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
       ...
       created() {
           ...
           axios.get('http://localhost/Jproject/public/api/get-product-by-id/' + this.id).then(response=>{
